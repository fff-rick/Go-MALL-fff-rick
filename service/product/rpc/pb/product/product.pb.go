...
func (x *CreateResponse) GetDesc() string {
	if x != nil {
		return x.Desc
	}
	return ""
...
func (x *CreateResponse) GetStock() int64 {
	if x != nil {
		return x.Stock
	}
	return 0
...
func (x *UpdateResponse) GetStock() int64 {
	if x != nil {
		return x.Stock
	}
	return 0
...
const file_product_proto_rawDesc = "" +
	...
	"\x06Status\x18\x05 \x01(\x03R\x06Status\"\x8e\x01\n" +
	...
	"\x05Stock\x18\x04 \x01(\x03R\x05Stock\x12\x16\n" +
	"\x06Amount\x18\x05 \x01(\x03R\x06Amount\x12\x16\n" +
	"\x06Status\x18\x06 \x01(\x03R\x06Status\"\x8e\x01\n" +
	...
	"\x05Stock\x18\x04 \x01(\x03R\x05Stock\x12\x16\n" +
	"\x06Amount\x18\x05 \x01(\x03R\x06Amount\x12\x16\n" +
	"\x06Status\x18\x06 \x01(\x03R\x06Status\"\x1f\n" +
...
var file_product_proto_depIdxs = []int32{
	...
	5, // 8: product.Product.Remove:output_type -> product.RemoveResponse
